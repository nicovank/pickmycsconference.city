...
def find_nearest_city(target_coords: tuple[float, float]) -> dict:
...
if __name__ == '__main__':
    ...
    print(f"Nearest City: {city['city']}, Country: {city['country']}, Coordinates: ({city['latitude']}, {city['longitude']}), Distance: {city['distance']} miles")
