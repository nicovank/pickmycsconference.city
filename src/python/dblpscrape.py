...
def get_details_from_xml(pub_id: str) -> Optional[str]:
    """
...
def ensure_conference_exists(cur, conference_name, year):
    """
...
def main() -> None:
    ...
    parser.add_argument("--conference", required=True, help="The short name of the conference (e.g., 'OSDI')")
    parser.add_argument("--year", required=True, type=int, help="The year of the conference (e.g., 2025)")
