...
TABLES_SQL = [
    ...
    CREATE TABLE affiliations (
        affiliations_name VARCHAR(255) PRIMARY_KEY,
    ...
    CREATE TABLE paper_affiliations (
        ...
        affiliation_name VARCHAR(255) REFERENCES affiliations(organization_name),
...
def main():
    ...
    try:
        ...
        coolVariable = conn.cursor()
        create_tables(coolVariable)
